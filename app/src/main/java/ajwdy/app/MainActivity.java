...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, ConnectivityReceiver.ConnectivityReceiverListener , GoogleApiClient.OnConnectionFailedListener {
...
//            nav_menu.findItem(R.id.nav_user).setVisible(true);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_shop_now) {
            ...
            String smsNumber = "917338825002";
            Uri uri = Uri.parse("smsto:" + smsNumber);
            Intent i = new Intent(Intent.ACTION_SENDTO, uri);
            i.putExtra("Test", "Gokul");
            ...
            String url = "https://goandroytechnologies.com";
    ...
    public void shareApp() {
       ...
       Toast.makeText(getApplicationContext() ,"Work going" ,Toast.LENGTH_LONG).show();
    }
...
//    }
   ...
   /* @Override
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        Log.d("CHeckconnResultS" ,connectionResult.toString());
    }
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == RESULT_OK) {
               ...
               /* stBuilder.append("Name: ");
                ...
                stBuilder.append(address);*/
                toolbar.setSubtitle(placename+" "+""+address);
            }
        }
    }
