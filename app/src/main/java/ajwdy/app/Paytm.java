...
public class Paytm extends Activity {
    ...
    String url = "http://neerajbisht.com/grocery_test/paytm/generateChecksumPost.php";
...
//                wr.writeBytes("PostData=" + params[1]);
        ...
        protected void onPostExecute(String result) {
            ...
            PaytmMerchant Merchant = new PaytmMerchant(
                    "http://neerajbisht.com/grocery_test/paytm/generateChecksum.php",
                    "http://neerajbisht.com/grocery_test/paytm/verifyChecksum.php");
